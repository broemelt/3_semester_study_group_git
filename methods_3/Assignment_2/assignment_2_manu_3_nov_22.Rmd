...
matrix_pitch <- matrix_ma %>% 
  select('StudyID','Article', 'PITCH_F0SD_HC_M','PITCH_F0SD_HC_SD','PITCH_F0SD_SZ_M','PITCH_F0SD_SZ_SD')
...
matrix_pitch <- matrix_pitch %>% 
  mutate(
    pooled_sd=
      sqrt(
        (matrix_pitch$PITCH_F0SD_SZ_SD^2+matrix_pitch$PITCH_F0SD_HC_SD^2)))
